...
const EditQuestionForm = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:3000/get-question/${competitionId}/${questionId}`)
  ...
  const handleUpdate = async (event) => {
    ...
    try {
      await axios.put(`http://localhost:3000/update-question/${competitionId}/${questionId}`, updatedQuestion);
