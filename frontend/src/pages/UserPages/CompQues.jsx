...
const CompQuesPage = () =>{
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3000/get-questions/${competitionId}`).then((res) => {
            console.log(res.data);
            setCompetition(res.data.questionsList);
        });

        //retrieve total score of each user 
         axios.get(`http://localhost:3000/get-total-score/${competitionId}/${participantId}`)
         .then((res) => {
            console.log(res.data);
          ...
          axios.get(`http://localhost:3000/get-leaderboard/${competitionId}`)  
            .then((res) => {
            ...
            axios.get(`http://localhost:3000/get-competition/${competitionId}`).then((res) => {
