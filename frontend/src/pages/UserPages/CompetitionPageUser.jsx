...
function CompFun() {
    ...
    const handleJoin = (id) => {
        ...
        if(!user){
            ...
            axios.get(`http://localhost:3000/check-enrolled/${id}/${auth.currentUser.uid}`)
            .then((response) => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:3000/get-ongoing-competitions')
        .then((response) => {
        ...
        axios.get('http://localhost:3000/get-upcoming-competitions')
        .then((response) => {
